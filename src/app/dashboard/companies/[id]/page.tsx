...
export default async function CompanyDetailsPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="p-6 max-w-xl">
      ...
      <p><span className="font-medium">صنعت:</span> {company.industry}</p>
      <p><span className="font-medium">موقعیت:</span> {company.location || "نامشخص"}</p>
      <p className="mt-4"><span className="font-medium">توضیحات:</span> {company.description}</p>
